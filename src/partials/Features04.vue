      ...
      <div class="pt-16 pb-12 md:pt-32 md:pb-20">
        ...
        <div class="divide-y divide-slate-800">
          ...
          <div class="py-8 first-of-type:pt-0 last-of-type:pb-0">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{ $t('features04.groups.0.title') }}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              ...
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[0].features[0].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[0].features[0].description`) }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[0].features[1].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[0].features[1].description`) }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[0].features[2].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[0].features[2].description`) }}</p>
              </div>
            </div>
          </div>
          <!-- Row -->
          <div class="py-8">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{ $t('features04.groups.1.title') }}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[1].features[0].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[1].features[0].description`) }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[1].features[1].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[1].features[1].description`) }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[1].features[2].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[1].features[2].description`) }}</p>
              </div>
            </div>
          </div>
          <!-- Row -->
          <div class="py-8">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{ $t('features04.groups.2.title') }}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[2].features[0].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[2].features[0].description`) }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[2].features[1].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[2].features[1].description`) }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t(`features04.groups[2].features[2].title`) }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t(`features04.groups[2].features[2].description`) }}</p>
              </div>
            </div>
          </div>
        </div>
